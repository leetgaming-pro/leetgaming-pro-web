  ...
  return (
    <article className="prose prose-invert max-w-none">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold mb-0 text-[#34445C] dark:text-[#F5F0E1]">Terms of Service</h1>
      ...
      <section className="mb-8 p-6 rounded-none border-l-4 border-[#FF4654] dark:border-[#DCFF37] bg-[#34445C]/5 dark:bg-[#DCFF37]/5">
        <h2 className="text-xl font-semibold mb-4 text-[#34445C] dark:text-[#F5F0E1]">1. Acceptance of Terms</h2>
      ...
      <section className="mb-8">
        ...
        <p className="text-default-600 mb-4">To use LeetGaming.PRO, you must:</p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">4. Fair Play and Conduct</h2>
        <p className="text-default-600 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">6. Premium Services and Payments</h2>
        <p className="text-default-600 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">7. Prize Pools and Winnings</h2>
        <p className="text-default-600 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">8. Content Guidelines</h2>
        <p className="text-default-600 mb-4">
      ...
      <section>
        ...
        <ul className="list-none text-default-600 space-y-1">
          <li>
            Email:{' '}
            <a href="mailto:legal@leetgaming.pro" className="text-primary hover:underline">
              legal@leetgaming.pro
            </a>
          </li>
          <li>
            Support:{' '}
            <a href="mailto:support@leetgaming.pro" className="text-primary hover:underline">
