  ...
  if (status === 'loading') {
    return (
      <div className="flex flex-col justify-center items-center w-full h-screen bg-black">
        ...
        <Progress color="warning" isIndeterminate aria-label="Loading..." className="max-w-md" size="sm" />
  ...
  if (status === 'authenticated') {
    return (
      <div className="flex flex-col justify-center items-center w-full h-screen bg-black">
        ...
        <Progress color="success" isIndeterminate aria-label="Redirecting..." className="max-w-md" size="sm" />
        <span className="text-white/50 mt-4">Authenticated. Redirecting...</span>
      </div>
    );
  }
