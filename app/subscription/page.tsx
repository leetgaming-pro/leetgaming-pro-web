        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#F5F0E1] mb-4 flex items-center gap-2">
              <Icon icon="solar:crown-bold" className="text-[#FFC700] w-6 h-6" />
              Current Plan
            </h2>
            {currentSubscription ? (
              <SubscriptionManagement subscription={mapSubscription(currentSubscription)} />
            ) : (
              <Card className="rounded-none border border-[#34445C]">
                <CardBody className="p-8 text-center">
                  <div className="w-16 h-16 rounded-none bg-[#34445C] flex items-center justify-center mx-auto mb-4">
                    <Icon icon="solar:star-bold" className="text-[#FFC700] w-8 h-8" />
                  </div>
                  <h3 className="text-lg font-semibold text-[#F5F0E1] mb-2">No Active Subscription</h3>
                  ...
                  <Button
                    ...
                    startContent={<Icon icon="solar:rocket-bold" className="w-5 h-5" />}
                  >
                    View Plans
                  </Button>
                </CardBody>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#F5F0E1] mb-4 flex items-center gap-2">
              <Icon icon="solar:document-text-bold" className="text-[#DCFF37] w-6 h-6" />
              Payment History
            </h2>
            <PaymentHistory />
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#F5F0E1] mb-4 flex items-center gap-2">
              <Icon icon="solar:settings-bold" className="text-[#FF4654] w-6 h-6" />
              Quick Actions
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <Card isPressable className="rounded-none border border-[#34445C] hover:border-[#DCFF37]/50 transition-colors" onPress={() => router.push('/pricing')}>
                <CardBody className="p-4 flex flex-row items-center gap-3">
                  <div className="w-10 h-10 rounded-none bg-[#FF4654]/20 flex items-center justify-center">
                    <Icon icon="solar:arrow-up-bold" className="text-[#FF4654] w-5 h-5" />
                  </div>
                  <div>
                    <p className="font-medium text-[#F5F0E1]">Upgrade Plan</p>
                    <p className="text-xs text-[#F5F0E1]/50">Get more features</p>
                  </div>
                </CardBody>
              </Card>
              <Card isPressable className="rounded-none border border-[#34445C] hover:border-[#DCFF37]/50 transition-colors" onPress={() => router.push('/wallet')}>
                <CardBody className="p-4 flex flex-row items-center gap-3">
                  <div className="w-10 h-10 rounded-none bg-[#DCFF37]/20 flex items-center justify-center">
                    <Icon icon="solar:wallet-bold" className="text-[#DCFF37] w-5 h-5" />
                  </div>
                  <div>
                    <p className="font-medium text-[#F5F0E1]">Wallet</p>
                    <p className="text-xs text-[#F5F0E1]/50">Manage your funds</p>
                  </div>
                </CardBody>
              </Card>
              <Card isPressable className="rounded-none border border-[#34445C] hover:border-[#DCFF37]/50 transition-colors" onPress={() => router.push('/settings?tab=billing')}>
                <CardBody className="p-4 flex flex-row items-center gap-3">
                  <div className="w-10 h-10 rounded-none bg-[#FFC700]/20 flex items-center justify-center">
                    <Icon icon="solar:card-bold" className="text-[#FFC700] w-5 h-5" />
                  </div>
                  <div>
                    <p className="font-medium text-[#F5F0E1]">Payment Methods</p>
                    <p className="text-xs text-[#F5F0E1]/50">Update billing info</p>
                  </div>
                </CardBody>
              </Card>
            </div>
