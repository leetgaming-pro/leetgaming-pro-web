...
export default function LeaderboardsPage() {
  ...
  // Fetch leaderboard data from API using SDK context
  useEffect(() => {
    async function fetchLeaderboards() {
      ...
      try {
        ...
        // Fetch player leaderboard using SDK context
        ...
        const mappedPlayers: LeaderboardPlayer[] = players.map(
          (p: PlayerProfileWithStats, index: number) => ({
            rank: index + 1,
        ...
        const mappedTeams = teams.map((t: SquadWithStats, index: number) => ({
          ...
          avatar:
            t.logo_uri || "https://avatars.githubusercontent.com/u/168373383",
          rating: t.rating || 0,
          wins: t.stats?.wins || 0,
    ...
    fetchLeaderboards();
  }, [selectedGame, selectedRegion, sdk, isReady]);
  ...
  return (
    <div className="flex w-full flex-col items-center gap-8 px-4 py-8 lg:px-24 pb-28 md:pb-8">
      {/* Header */}
      <div className="flex w-full max-w-7xl flex-col items-center text-center gap-4">
        ...
        <p className={subtitle({ class: "mt-2 max-w-2xl" })}>
          Track the top players and teams across all competitive games. Rankings
          updated daily.
        </p>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
            <Select
              ...
              onSelectionChange={(keys) =>
                setSelectedGame(Array.from(keys)[0] as string)
              }
            ...
            >
              <SelectItem key="cs2" value="cs2">
                CS2
              </SelectItem>
              <SelectItem key="csgo" value="csgo">
                CS:GO
              </SelectItem>
              <SelectItem key="valorant" value="valorant">
                Valorant
              </SelectItem>
            </Select>
            <Select
      ...
      {!loading && (
        <div className="w-full max-w-7xl">
          <Tabs
            ...
            classNames={{
              tabList:
                "gap-6 w-full border-b border-[#FF4654]/20 dark:border-[#DCFF37]/20",
                ...
                <CardBody className="p-0">
                  ...
                  >
                    <TableHeader>
                      ...
                      <TableColumn className="text-center hidden md:table-cell">
                        W/L
                      </TableColumn>
                      <TableColumn className="text-center hidden md:table-cell">
                        WIN RATE
                      </TableColumn>
                      <TableColumn className="text-center hidden lg:table-cell">
                        K/D
                      </TableColumn>
      ...
      <Card className="w-full max-w-7xl bg-gradient-to-r from-primary-50 to-secondary-50">
        <CardBody className="text-center py-8">
          <Icon
            ...
            className="text-4xl mx-auto mb-2 text-primary"
          />
          <h3 className="text-lg font-semibold mb-2">
            Rankings Update Schedule
          </h3>
          <p className="text-default-600">
            Leaderboards are updated daily at 00:00 UTC. Play ranked matches to
            climb the ladder and earn your place among the top players!
          </p>
        </CardBody>
      </Card>
