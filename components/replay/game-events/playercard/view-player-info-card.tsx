...
export const ViewPayerInfoCard = () => {
  ...
  return (
    <Card
      shadow="none"
      className="max-w-[400px] border-none bg-transparent relative"
    >
      <CardHeader
      ...
      >
        <div
          className={
            theme === "dark"
              ? "profileBackdropContentDark flex gap-3 pl-2"
              : "profileBackdropContent flex gap-3 pl-2"
          }
        >
          <Badge
            content={"LXG"}
            style={{
              border: "1px solid #DCFF37",
              borderRadius: "5px",
              color: "#DCFF37",
          ...
          >
            <Avatar
              isBordered
              radius="sm"
              src="https://avatars.githubusercontent.com/u/29843116?v=4"
            />
          </Badge>
        ...
        <div className="grid pl-6">
          ...
          <Button
            startContent={
              <GameIconsLaurelCrown className="sm" width={24} height={24} />
            }
            radius="sm"
            size="sm"
            variant="solid"
            className={
              theme === "dark"
                ? "viewProfileHighlightsButtonDark"
                : "viewProfileHighlightsButton"
            }
          >
            View Highlight
          </Button>
          ...
          <Button
            ...
            size="sm"
            variant="faded"
            startContent={<UserIcon size={20} width={20} height={20} />}
          >
            View Profile
          </Button>
          <Spacer x={1} />
      ...
      <div className="flex gap-1">
        ...
        <MatchHeader
          ...
          mapName="de_dust2"
          team1Name="Team A"
          team1Logo="/teams/default.png"
          team1Score={0}
          team2Name="Team B"
          team2Logo="/teams/default.png"
          team2Score={0}
          rounds={[]}
        />
      </CardBody>
      <CardFooter className="gap-3">
        <Breadcrumbs className="pt-0">
          ...
          <BreadcrumbItem>
            <Chip variant="faded">
              <small>Clutch Situation</small>
            </Chip>
          </BreadcrumbItem>
          <BreadcrumbItem className="text-small sm">
            <Chip variant="dot" className="sm" color="danger">
              <small>1 vs 3</small>
            </Chip>
          </BreadcrumbItem>
          <BreadcrumbItem>
