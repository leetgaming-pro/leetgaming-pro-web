...
const SubmitReplay: React.FC = () => {
  const [_replayUrl, _setReplayUrl] = useState("");
      ...
      >
        ...
        >
          ...
          <Input
            ...
            classNames={{
              inputWrapper:
                "rounded-none border-[#34445C]/30 dark:border-[#DCFF37]/30 bg-[#F5F0E1] dark:bg-[#111111]",
            }}
            endContent={
              <CopyDocumentIcon className="text-[#34445C] dark:text-[#DCFF37]" />
            }
            startContent={
              <SteamIcon
                width={36}
                className="text-[#34445C] dark:text-[#F5F0E1]"
              />
            }
          />
          <Spacer y={2} />
          ...
          <Card className="w-full max-w-md p-6 rounded-none border border-[#FF4654]/20 dark:border-[#DCFF37]/20 bg-[#F5F0E1]/50 dark:bg-[#0a0a0a]/50">
            <CardHeader className="flex-col items-start gap-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className={title({ color: "battleNavy", size: "sm" })}>
                    CLI
                  </h3>
                </div>
              </div>
