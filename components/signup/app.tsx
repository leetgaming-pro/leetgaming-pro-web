    ...
    >
      ...
      >
        ...
        <div className="text-center pb-2">
          ...
          >
            <span className="text-xl text-[#F5F0E1] dark:text-[#34445C]">
              🎮
            </span>
          </div>
          <h1 className="text-2xl font-bold tracking-tight text-[#34445C] dark:text-[#F5F0E1]">
            Create Account
          </h1>
          <p className="text-sm text-[#34445C]/60 dark:text-[#F5F0E1]/60 mt-1">
            Join LeetGaming.PRO today
          </p>
        </div>
        ...
        <p className="text-center text-sm text-[#34445C]/60 dark:text-[#F5F0E1]/60">
          ...
          <Link
            href="/signin"
            size="sm"
            className="font-medium text-[#FF4654] dark:text-[#DCFF37]"
          >
            Log In
          </Link>
        </p>
