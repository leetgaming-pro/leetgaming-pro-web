...
export function StarredIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="m1416 1254l248 794l-640-492l-640 492l248-794L0 768h784L1024 0l240 768h784z"
      ></path>
    </svg>
  );
}
...
export const BestOfThreeMatchIcon = ({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M9 17.25h4q.875 0 1.438-.625T15 15.25v-.75q0-.575-.425-1.037T13.5 13q.65 0 1.075-.462T15 11.5v-.75q0-.75-.562-1.375T13 8.75H9v2h4V12h-3v2h3v1.25H9zM9 3V1h6v2zm3 19q-1.85 0-3.488-.712T5.65 19.35t-1.937-2.863T3 13t.713-3.488T5.65 6.65t2.863-1.937T12 4q1.55 0 2.975.5t2.675 1.45l1.4-1.4l1.4 1.4l-1.4 1.4Q20 8.6 20.5 10.025T21 13q0 1.85-.713 3.488T18.35 19.35t-2.863 1.938T12 22"
      ></path>
    </svg>
  );
};
