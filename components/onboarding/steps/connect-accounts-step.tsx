...
export function ConnectAccountsStep() {
  const {
    state,
    updateConnectedAccounts: _updateConnectedAccounts,
    goToNextStep,
    skipStep,
  } = useOnboarding();
        ...
        <div className="p-3 bg-warning/10 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <p className="text-sm text-warning-600">
              Connecting Steam is highly recommended for CS2/Valorant players to
              import your match history and stats.
            </p>
          </div>
        </div>
      )}
