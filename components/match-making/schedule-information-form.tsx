    ...
    <>
      <div className="flex flex-col items-center text-center mb-6">
        ...
        <div className="py-2 text-default-500 max-w-md">
          Set your availability to find matches when you&apos;re ready to
          compete
        </div>
      </div>
          ...
          <Card className="rounded-none border border-[#FF4654]/20 dark:border-[#DCFF37]/20">
            <CardBody className="p-6">
              <div className="flex flex-col items-center text-center gap-4">
                <div
                  className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-[#FF4654] to-[#FFC700] dark:from-[#DCFF37] dark:to-[#34445C] rounded-none"
                  style={{
                    clipPath:
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#34445C] dark:text-[#DCFF37]">
                    Ready to Play Now
                  </h3>
          ...
          <Card className="rounded-none border border-[#FF4654]/20 dark:border-[#DCFF37]/20">
            <CardHeader className="flex flex-col gap-4 p-6 pb-2">
              ...
              <p className="text-default-500 text-sm">
                {value instanceof ZonedDateTime
                  ? `Your local time: ${formatDateToTimezone(
                      value.toDate(),
            ...
            <CardBody className="p-6 pt-2">
              <CheckboxGroup
                ...
                classNames={{
                  label:
                    "text-[#34445C] dark:text-[#DCFF37] font-semibold mb-2",
                }}
                onValueChange={(newSelected) => {
                  setSelected(newSelected);
                  updateState({
                    scheduleType: "weekly-routine",
                    weeklyRoutine: newSelected,
                  });
                }}
              >
              ...
              {selected.length > 0 && (
                <div className="mt-4 p-3 bg-[#34445C]/5 dark:bg-[#DCFF37]/5 rounded-none border-l-2 border-[#FF4654] dark:border-[#DCFF37]">
                  <p className="text-sm text-default-600">
                    ✓ Available on:{" "}
                    <span className="font-semibold text-[#34445C] dark:text-[#DCFF37]">
                      {selected
