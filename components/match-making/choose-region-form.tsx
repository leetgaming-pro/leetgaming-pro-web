...
import { NetworkFavorite } from "../logo/icons/aerodynamic-harpoon";
...
const ChooseRegionForm = React.forwardRef<
  HTMLFormElement,
  ChooseRegionFormProps
>(({ className, ...props }, ref) => {
  ...
  const radioClassNames = {
    ...
    control:
      "bg-gradient-to-r from-[#FF4654] to-[#FFC700] dark:bg-[#DCFF37] text-white dark:text-[#1a1a1a]",
    wrapper:
      "group-data-[selected=true]:border-[#FF4654] dark:group-data-[selected=true]:border-[#DCFF37]",
  ...
  return (
    <>
      ...
      <form
        ref={ref}
        className={cn(
          "w-full flex grid grid-cols-12 flex-col items-center justify-center text-center px-2 sm:px-0",
          className,
        )}
        {...props}
      >
          ...
          <div className="flex w-full flex-col">
            <Tabs
              ...
              classNames={{
                ...
                tabList:
                  "bg-[#F5F0E1] dark:bg-[#1a1a1a] p-1 rounded-none gap-1 shadow-sm border border-[#FF4654]/20 dark:border-[#DCFF37]/20",
        ...
        <div className="col-span-12 mt-4">
          ...
          >
            <span className="text-white dark:text-[#1a1a1a] font-semibold">
              Auto-Select Best Server
            </span>
          </BattleButton>
          <p className="text-xs text-default-400 mt-2">
            Ping test to find your optimal region
          </p>
        </div>
      </form>
    </>
