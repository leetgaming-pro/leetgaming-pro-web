...
const FloatingElement = dynamic(() => import("@/lib/3d/floating-element"), {
  ssr: false,
});
...
const PILLARS = [
  {
    titleKey: "landing.productOverview.pillars.replay.title",
    descriptionKey: "landing.productOverview.pillars.replay.description",
  ...
  {
    titleKey: "landing.productOverview.pillars.matchmaking.title",
    descriptionKey: "landing.productOverview.pillars.matchmaking.description",
  ...
  {
    titleKey: "landing.productOverview.pillars.tournaments.title",
    descriptionKey: "landing.productOverview.pillars.tournaments.description",
  ...
  {
    titleKey: "landing.productOverview.pillars.prizes.title",
    descriptionKey: "landing.productOverview.pillars.prizes.description",
    ...
    <section className="landing-section relative py-24 md:py-32 bg-background overflow-hidden">
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl relative z-10">
        <LazyMotion features={domAnimation}>
          ...
          >
            <span
              className={`${electrolize.className} text-xs sm:text-sm uppercase tracking-[0.3em] text-[#FF4654] dark:text-[#DCFF37] mb-4 block`}
            >
              {t("landing.productOverview.eyebrow")}
            </span>
            <h2
              className={`${electrolize.className} text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4 uppercase tracking-tight`}
            >
              {t("landing.productOverview.titlePrefix")}{" "}
              <span className="text-[#FF4654] dark:text-[#DCFF37]">
                {t("landing.productOverview.titleHighlight")}
              </span>
            </h2>
            <p className="text-default-500 text-base sm:text-lg max-w-2xl mx-auto">
              {t("landing.productOverview.subtitle")}
            </p>
          </m.div>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 p-6 sm:p-8">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3
                        className={`${electrolize.className} text-lg sm:text-xl font-bold text-foreground uppercase tracking-wide`}
                      >
                        {t(pillar.titleKey)}
                      </h3>
                    </div>
