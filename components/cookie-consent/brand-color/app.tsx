...
export default function CookieConsentBrandColors(params: any) {
  ...
  const _isLightTheme = _theme === "light";

  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0" {...params}>
      <div
        className="pointer-events-auto flex w-full items-center justify-between gap-x-20 border border-divider px-6 py-4 shadow-small"
        style={{
      ...
      >
        <p className="text-small font-normal text-primary-foreground">
          ...
          <Icon
            className="ml-2 inline-block h-8 w-8 text-primary-200"
            icon="lucide:cookie"
          />
        </p>
