...
export type EsportsButtonVariant =
  | "primary"
  | "action"
  | "ghost"
  | "danger"
...
export const EsportsButton = React.forwardRef<
  HTMLButtonElement,
  EsportsButtonProps
>(
  (
    ...
    // Support for custom components like Next.js Link
    if (typeof as !== "string") {
      const Component = as;
      return (
        <Component href={href} className={baseClasses}>
          {content}
        </Component>
      );
    }
